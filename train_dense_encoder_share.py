...
class BiEncoderTrainer(object):
    ...
    def __init__(self, args):
        ...
        if args.encoder_model_type == 'hf_bert_share_att_pooler':
            from dpr.models.biencoder_att_pooler import BiEncoderNllLoss
    ...
    def validate_average_rank(self) -> float:
        ...
        sim_score_f = NllLoss().get_similarity_function()
        q_represenations = []
        ctx_represenations = []
